...
The HERE Mobility SDK version 1.1.60 supports Android version 4.1 (API level 16) or later.
...
dependencies{
	...
	implementation "com.here.mobility.sdk:demand:1.1.60"
	implementation "com.here.mobility.sdk:map:1.1.60"
}
```
